...
if(!function_exists('apc_cache_info')) {
	echo "No cache info available.  APC does not appear to be running. Please check PHP section of MAMP PRO for the selected cache module. If you are running PHP 7 make sure you have apcu.so AND apc.so enabled in the PHP.ini file.";
  exit;
}
